...
<head>
	...
	<title>House Rental Portal | Admin Edit House Info</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Month(in Ksh)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Year of Development<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">General Features</div>
<div class="panel-body">
...
<label for="inlineCheckbox1">Wi-FI </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2"> Radio </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Terrace</label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Bedding</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Cable TV </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Microwave </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> CD/DVD </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Computer</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Gated </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
